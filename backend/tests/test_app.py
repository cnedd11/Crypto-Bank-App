...
from app import db
from app.routes.auth import _failed_logins  # noqa: F401
...
def test_brute_force_lockout(client):
    ...
    """
    from app.routes.auth import MAX_LOGIN_ATTEMPTS
...
def test_wallets_crud(client):
    # Login before any customer/wallet operations (all routes are auth-guarded)
